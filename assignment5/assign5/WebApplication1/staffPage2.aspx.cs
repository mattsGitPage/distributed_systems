...
namespace WebApplication1
{
    public partial class staffPage2 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            doc.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"c:\Users\matthew dunning\documents\visual studio 2015\Projects\assign5\WebApplication1\xml\staffpage2users.xml"));
            ...
            foreach (XmlNode xn in xnList)
            {
                ...
                if (user == userName && password == userPassword && auth == authenticate && author == authorize)
                {
                    ...
                    Response.Redirect("http://localhost:49861/staff2secret");
                    found = true;
                }
            }
